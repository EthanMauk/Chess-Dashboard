...
export function normalizeGames(rows) {
  return rows
    ...
    .map((r) => ({
      ...
      playerOpeningMateBlunders: num(r.player_opening_mate_blunders),
      opponentOpeningMateBlunders: num(r.opponent_opening_mate_blunders),
      playerMiddlegameMateBlunders: num(r.player_middlegame_mate_blunders),
      opponentMiddlegameMateBlunders: num(r.opponent_middlegame_mate_blunders),
      playerEndgameMateBlunders: num(r.player_endgame_mate_blunders),
      opponentEndgameMateBlunders: num(r.opponent_endgame_mate_blunders),
      playerOpeningNormalBlunders: num(r.player_opening_normal_blunders),
      opponentOpeningNormalBlunders: num(r.opponent_opening_normal_blunders),
      playerMiddlegameNormalBlunders: num(r.player_middlegame_normal_blunders),
      opponentMiddlegameNormalBlunders: num(r.opponent_middlegame_normal_blunders),
      playerEndgameNormalBlunders: num(r.player_endgame_normal_blunders),
      opponentEndgameNormalBlunders: num(r.opponent_endgame_normal_blunders),
